  ...
  return (
    <div className="flex items-center px-16">
      <div className="flex flex-col w-[45%]">
        <div className="text-6xl font-bold leading-tight text-mine-shaft-100 [&>span]:text-bright-sun-400 gap-3">
          Find your <span>dream</span> <span>job</span> with us.
        </div>
        <div className="text-mine-shaft-200">Good life begins with good company. Start exploring thousands of jobs in one place.</div>
      ...
      <div className="w-[55%] flex items-center">
        <div className="w-[38rem]">
          <img src='/images/laptop_boy.png' alt="Illustration of a boy using a laptop" />
